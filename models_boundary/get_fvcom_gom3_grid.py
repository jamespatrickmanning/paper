...
#    a='disk'
    ...
    # quick load from disk
        x=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.x.npy')
        y=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.y.npy')
        xc=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.xc.npy')
        yc=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.yc.npy')
        
        lon=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.lon.npy')
        lat=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.lat.npy')
        lonc=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.lonc.npy')
        latc=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.latc.npy')
        
        coslat=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.coslat.npy')
        coslatc=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.coslatc.npy')
        
        h=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.h.npy')
        
        kvf=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.kvf.npy')
        kff=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.kff.npy')
        kvv=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.kvv.npy')
        nvv=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.nvv.npy')
        kfv=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.kfv.npy')
        nfv=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.nfv.npy')
    ...
    # load native fvcom variables from disk and calculate variables with new names
        ...
        nbsn=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.nbsn.npy')
        ...
        ntsn=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.ntsn.npy')
        ...
        nbve=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.nbve.npy')
        ...
        ntve=np.load('E:\\Mingchao\\result\\npy\\'+'gom3.ntve.npy')
        ...
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.coslat.npy',coslat)
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.coslatc.npy',coslatc)
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.kvf.npy',kvf)
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.kff.npy',kff)
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.kvv.npy',kvv)
        np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nvv.npy',nvv)
        ...
        a1u=ds['a1u']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.a1u.npy',np.array(a1u))
        a2u=ds['a2u']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.a2u.npy',np.array(a2u))
        art1=ds['art1']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.art1.npy',np.array(art1))
        art2=ds['art2']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.art2.npy',np.array(art2))
        aw0=ds['aw0']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.aw0.npy',np.array(aw0))
        awx=ds['awx']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.awx.npy',np.array(awx))
        awy=ds['awy']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.awy.npy',np.array(awy))
        #cc_hvc=ds['cc_hvc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.cc_hvc.npy',np.array(cc_hvc))
            
        h=ds['h']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.h.npy',np.array(h))
        
        lat=ds['lat']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.lat.npy',np.array(lat))
        lon=ds['lon']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.lon.npy',np.array(lon))
        latc=ds['latc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.latc.npy',np.array(latc))
        lonc=ds['lonc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.lonc.npy',np.array(lonc))
        
        nbe=ds['nbe']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nbe.npy',np.array(nbe))
        nbsn=ds['nbsn']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nbsn.npy',np.array(nbsn))
        nbve=ds['nbve']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nbve.npy',np.array(nbve))
        #nn_hvc=ds['nn_hvc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nn_hvc.npy',np.array(nn_hvc))
        nprocs=ds['nprocs']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nprocs.npy',np.array(nprocs))
        ntsn=ds['ntsn']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.ntsn.npy',np.array(ntsn))
        ntve=ds['ntve']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.ntve.npy',np.array(ntve))
        nv=ds['nv']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.nv.npy',np.array(nv))
        partition=ds['partition']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.partition.npy',np.array(partition))
        siglay=ds['siglay']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.siglay.npy',np.array(siglay))
        siglev=ds['siglev']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.siglev.npy',np.array(siglev))
        
        x=ds['x']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.x.npy',np.array(x))
        xc=ds['xc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.xc.npy',np.array(xc))
        y=ds['y']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.y.npy',np.array(y))
        yc=ds['yc']; np.save('E:\\Mingchao\\result\\npy\\'+'gom3.yc.npy',np.array(yc))
        ...
        #Grid=np.load('Grid.npy').item()
        Grid=np.load('E:\\Mingchao\\result\\npy\\Grid.npy').item()
...
##if __name__ == "__main__":
    #G=get_fvcom_gom3_grid(a='server')